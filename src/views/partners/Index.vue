<template>
  <b-row>
    <b-col md="12" class="d-flex justify-content-between mb-1">
      ...
      <router-link :to="{name: 'partner-create'}">
        <b-button
            target="_blank"
            variant="success"
        ...
        >
          ...
          <feather-icon size="18" icon="PlusCircleIcon" style="padding-left: 4px"/>
        </b-button>
      </router-link>
    </b-col>
    <b-col md="12">
      <b-table :items="items" :fields="fields" :busy="loading">
        ...
        <template #cell(image)="data">
          <img :src="data.item.image" width="70" height="70" style="object-fit: contain" alt="">
        </template>
        ...
        <template #cell(action)="data">
          <div class="float-right">
            <router-link :to="{name: 'partner-update', params: {id: data.item.id}}">
              <b-button variant="warning" size="small" class="btn-icon mr-1">
              ...
              >
                ...
                <template #modal-footer>
                  ...
                  <b-button
                      ...
                      @click="deactivate(data.item.id, data.item.active)"
                  >
                    Деактивировать
                  </b-button>
                </template>
