  ...
  <b-row>
    ...
    <div class="d-flex justify-content-between col-12">
      ...
      <div class="d-flex align-items-center justify-content-center float-right">
        <router-link class="create__btn btn-primary" :to="{name:'dealer-create'}">Создать</router-link>
      </div>
      ...
      >
        ...
        <template #cell(crud_row)="data">
          <div class="d-flex float-right">
            ...
            <!--    EDIT    -->
            <router-link :to="{path:`dealer/update/${data.item.id}`}">
            ...
            >
              ...
              <b-modal
                  ...
                  centered
              >
                Вы действительно хотите деактивировать этот дилер?
                ...
                <template #modal-footer>
                  ...
                  <b-button
                      ...
                      @click="deactivateDealer(data.item.id, data.item.active)"
                  >
                    Деактивировать
                  </b-button>
                </template>
...
export default {
  ...
  methods: {
    ...
    async getDealers() {
      this.isBusy = true
      await api.dealers.fetchDealers()
          .then(res => {
