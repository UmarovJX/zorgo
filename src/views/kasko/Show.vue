<template>
    <b-row>
            ...
            <b-row>
                ...
                <b-col md="3">
                    <div class="d-flex justify-content-end">
                        <b-button v-if="policy.policy" :href="policy.policy.contract_url" target="_blank"
                            variant="success" class="btn-icon d-flex align-items-center">
                            <span style="padding-right: 4px">Скачать Полис</span>
                            <feather-icon size="18" icon="DownloadCloudIcon" style="padding-left: 4px" />
                        </b-button>
                        <b-button v-if="policy.document" :href="policy.document.contract_url" target="_blank"
                            variant="success" class="btn-icon d-flex align-items-center ml-1">
                            <span style="padding-right: 4px">Скачать Документ</span>
                            <feather-icon size="18" icon="DownloadCloudIcon" style="padding-left: 4px" />
                        </b-button>
                    </div>
                </b-col>
        ...
        <b-col md="3" sm="12" v-for="(driver, index) in policy.drivers" v-if="!(policy.owner_is_driver && index === 0)"
            :key="index">
            <b-card>
...
export default {
    ...
    computed: {
        ...
        vehiclePassport() {
            return (
                this.policy.vehicle.tech_passport_series +
                this.policy.vehicle.tech_passport_number
            );
        },
    },
    data() {
