        ...
        <div class="d-flex justify-content-between col-12">
            ...
            >
                <router-link
                    ...
                    class="create__btn btn-primary mr-1"
                    :to="{ name: positionPageName }"
                    >Изменить порядок</router-link
                >
                <router-link
...
export default {
    ...
    methods: {
        /////////////
        ...paginationHelperMethods("search[id]", {}),
