                            ...
                            <b-row>
                                <b-col cols="12" md="6">
                                    <b-form-group label="Осаго">
                                        ...
                                        <b-form-checkbox
                                            v-model="
                                                services.osago.driver_limit
                                            "
                                            class="custom-control-primary"
                                            name="check-button"
                                            switch
                                            >До 5 человек для города Ташкент и
                                            Ташкентской области</b-form-checkbox
                                        >
                                        <b-form-checkbox
                                            v-model="
                                                services.osago
                                                    .driver_limit_for_regions
                                            "
                                            class="custom-control-primary"
                                            name="check-button"
                                            switch
                                            >До 5 человек для
                                            регионов</b-form-checkbox
                                        >
                                        <b-form-checkbox
                                            v-model="
                                                services.osago.doc_insurance
                                            "
                                            class="custom-control-primary"
                                            name="check-button"
                                            switch
    ...
    methods: {
        ...
        update() {
            ...
            if (isValid) {
                ...
                formData.append(
                    "services[1][active]",
                    +this.services.travel.available
                );
