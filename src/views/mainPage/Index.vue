        ...
        <b-card>
          ...
          <b-row>
            ...
            <b-col cols="6" v-for="(data, key) in item.section_1.body">
              ...
              >
                <quill-editor v-model="item.section_1.body[key]"
                              ref="myQuillEditor"
        ...
        <b-card>
          ...
          <b-row>
            ...
            <b-col cols="6" v-for="(data, key) in item.section_3.body">
              ...
              >
                <quill-editor v-model="item.section_3.body[key]"
                              ref="myQuillEditor"
                              :options="quillEditorConfig">
                </quill-editor>
              </b-form-group>
            ...
            Object.keys(body).forEach(section => {
              Object.keys(body[section]).forEach(field => {
                if (typeof body[section][field] !== 'object') {
                  formData.append(`${section}[${field}]`, body[section][field])
                } else {
                  Object.keys(body[section][field]).forEach(key => {
                    formData.append(`${section}[${field}][${key}]`, body[section][field][key])
                  })
                }
              })
            })

            formData.append('section_1[image]', this.fileRecords[0].file)
